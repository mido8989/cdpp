...
public class IFHMBINNOCEANCDPP0013Controller {
    ...
    public Object upsertObject(@Valid @RequestBody IFHMBINNOCEANCDPP0013Payload.Request request, @RequestHeader MultiValueMap<String, String> headerMap) throws Exception {
        ...
        try {
            ...
            HashMap<String, IFHMBINNOCEANCDPP0013Dto> resultMap = service.upsertObject(dto);

            IFHMBINNOCEANCDPP0013Dto resultDto = resultMap.get("resultDto");
            ...
            IFHMBINNOCEANCDPP0013Dto oldAccount = resultMap.get("oldAccount");
